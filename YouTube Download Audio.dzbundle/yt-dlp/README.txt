...
-   devscripts/update-version.py [revision] - Update the version number
    based on current date
-   devscripts/set-variant.py variant [-M update_message] - Set the
    build variant of the executable
