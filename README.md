...
Shows a notification center notification that the task failed. Also terminates and cleans up the task and makes a cross show in the status item to indicate task failure. If you call this, you don't need to call $dz.url or $dz.text after.
